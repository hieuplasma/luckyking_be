...
const returnContent = 'Để nâng cấp hệ thống nhằm đem lại trải nghiệm tốt hơn cho Khách hàng, LuckyKing sẽ tiến hành bảo trì hệ thống từ 17h ngày 06/09/2023.'
@Injectable()
