-- CreateTable
CREATE TABLE IF NOT EXISTS "cms_async_ws_call" (
    "id" SERIAL NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "cms_email_sent" (
    "id" SERIAL NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "cms_email_sync_status" (
    "id" SERIAL NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "cms_preauth_token" (
    "id" SERIAL NOT NULL,
    "user_id" INTEGER,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "cms_setting_params" (
    "id" SERIAL NOT NULL,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "cms_user_action" (
    "id" SERIAL NOT NULL,
    "user_id" INTEGER,
...
-- CreateTable
CREATE TABLE IF NOT EXISTS "cms_user_oauth_token" (
    "id" SERIAL NOT NULL,
...
-- CreateIndex
CREATE INDEX IF NOT EXISTS "IDX_98d842825be8d1f77e29cd4841" ON "cms_preauth_token"("user_id");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "user_email_unique_idx" ON "cms_user"("email");

-- CreateIndex
CREATE UNIQUE INDEX IF NOT EXISTS "UQ_830a95c218d36815b33ef270fe3" ON "cms_user_oauth_token"("user_id");

-- AddForeignKey
ALTER TABLE "cms_async_ws_call" DROP CONSTRAINT IF EXISTS "FK_f38ac6708d79884ce99a2ca5a05";
...
-- AddForeignKey
ALTER TABLE "cms_preauth_token" DROP CONSTRAINT IF EXISTS "FK_98d842825be8d1f77e29cd48413";
...
-- AddForeignKey
ALTER TABLE "cms_session" DROP CONSTRAINT IF EXISTS "FK_ffb853ccef83e2b324dcef56dd0";
...
-- AddForeignKey
ALTER TABLE "cms_user" DROP CONSTRAINT IF EXISTS "FK_00bf1ecf58a37ebef2575da83f9";
...
-- AddForeignKey
ALTER TABLE "cms_user_action" DROP CONSTRAINT IF EXISTS "FK_dff16bed8c8ac186fcdcf44e946";
...
-- AddForeignKey
ALTER TABLE "cms_user_oauth_token" DROP CONSTRAINT IF EXISTS "FK_830a95c218d36815b33ef270fe3";
